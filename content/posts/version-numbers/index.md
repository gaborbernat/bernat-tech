...
topics = [ "python", "version", "semver", "calver", "0ver"]
draft = false
...
[install_requires and requirements.txt](https://packaging.python.org/en/latest/discussions/install-requires-vs-requirements/)).
